...
(function (global, chrome, document) {
  class Provider {
    ...
    createTag (id, host, env, elementId, attr, status) {
      ...
      return `"use strict";(function(e,t,r,n){r=t.getElementById("${elementId}");if(e.UDTracker||e.USERDIVEObject){r.setAttribute("${attr}","used")}else{(function(e,t,r,n,c,i,s,a){e.USERDIVEObject=c;e[c]=e[c]||function(){(e[c].queue=e[c].queue||[]).push(arguments)};s=t.createElement(r);a=t.getElementsByTagName(r)[0];s.async=1;s.src=n;s.charset=i;a.parentNode.insertBefore(s,a)})(window,t,"script","//${host}/static/UDTracker.js?"+(new Date).getTime(),"ud","UTF-8");e.ud("create","${id}",{env:"${env}",cookieExpires:1});e.ud("analyze")}setTimeout(function(){if(!e.UDTracker){console.warn("Blocked USERDIVE Scripts");return}try{n=e.UDTracker.cookie.fetch();var t=["pageId","visitorType"];var c={};for(var i in t){c[t[i]]=n[t[i]]}console.log(c);r.setAttribute("${status}",JSON.stringify(c))}catch(s){r.setAttribute("${attr}","err")}},2e3)})(window,document);`;
    }
    load () {
